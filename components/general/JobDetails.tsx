...
export const JobDetails = ({ job, jobListings, jobId }) => {
  ...
  return (
    <div className="flex flex-col items-center mt-10">
      <div className="w-full flex max-lg:flex-col gap-20 lg:items-center bg-blue-100 dark:bg-muted border border-blue-300 dark:border-neutral-900 rounded-xl px-10 lg:justify-between py-20">
        <div className="flex max-lg:flex-col lg:items-center gap-4 dark:text-white">
          <Image
        ...
        <div className="flex lg:flex-col gap-4 items-center ">
          <Button
            className="w-fit py-6 bg-blue-600 px-10 rounded-sm cursor-pointer hover:bg-blue-400 dark:text-white"
            onClick={handleApplyJob}
          >
            Apply Now
          </Button>
          <p className="text-gray-600 text-xs lg:text-center dark:text-white">
      ...
      <div className="w-full flex flex-col lg:grid grid-cols-5 gap-6 items-start pt-10 ">
        <div className="w-full col-span-3 flex flex-col gap-6  ">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-200 pl-4">
            {job.description}
          </p>
          ...
          <Button
            className="w-fit py-6 bg-blue-600  px-10 rounded-sm cursor-pointer hover:bg-blue-400 mt-4 dark:text-white"
            onClick={handleApplyJob}
          >
            Apply Now
          </Button>
        ...
        <div className="col-span-2 flex flex-col gap-6">
          <h1 className="text-md text-gray-600 dark:text-white">
